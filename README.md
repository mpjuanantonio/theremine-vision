...
A complete virtual theremin system that uses MediaPipe hand tracking to control audio synthesis in real time. Control pitch with your right hand and volume with your left hand, plus real-time vibrato and reverb effects.
